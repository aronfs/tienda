...
export const getDashboard = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.getDashboard(req.query as any, req.user!.companyId!);
...
export const getSalesAnalytics = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.getSalesAnalytics(req.query as any, req.user!.companyId!);
...
export const getRevenueAnalytics = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.getRevenueAnalytics(req.query as any, req.user!.companyId!);
...
export const getPurchaseAnalytics = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.getPurchaseAnalytics(req.query as any, req.user!.companyId!);
...
export const getProductAnalytics = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.getProductAnalytics(req.query as any, req.user!.companyId!);
...
export const getCategoryAnalytics = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.getCategoryAnalytics(req.query as any, req.user!.companyId!);
...
export const getClientAnalytics = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.getClientAnalytics(req.query as any, req.user!.companyId!);
...
export const getProviderAnalytics = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.getProviderAnalytics(req.query as any, req.user!.companyId!);
...
export const getInventoryAnalytics = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.getInventoryAnalytics(req.query as any, req.user!.companyId!);
...
export const getCashAnalytics = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.getCashAnalytics(req.query as any, req.user!.companyId!);
...
export const listReports = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.listReports(req.query as any, req.user!.companyId!);
...
export const generateReport = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.generateReport(req.body, req.user!.userId, req.user!.companyId!);
...
export const downloadReport = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.getReportDownload(Number(req.params.id), req.user!.companyId!);
  if (!data) throw new AppError("Reporte no encontrado", 404);
...
export const getChartRevenue = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.getChartRevenue(req.query as any, req.user!.companyId!);
  sendSuccess(res, data);
});

export const getChartProfit = asyncHandler(async (req: AuthRequest, res: Response) => {
  const range = await analyticsService.getChartRevenue(req.query as any, req.user!.companyId!);
  const profitData = {
    labels: range.labels,
...
export const getChartSales = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.getChartSales(req.query as any, req.user!.companyId!);
  sendSuccess(res, data);
});

export const getChartCategories = asyncHandler(async (req: AuthRequest, res: Response) => {
  const limit = Number(req.query.limit) || 10;
  const data = await analyticsService.getChartCategories(req.query as any, req.user!.companyId!, limit);
  sendSuccess(res, data);
});

export const getChartProducts = asyncHandler(async (req: AuthRequest, res: Response) => {
  const limit = Number(req.query.limit) || 10;
  const data = await analyticsService.getChartProducts(req.query as any, req.user!.companyId!, limit);
  sendSuccess(res, data);
});

export const getChartPayments = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.getChartPayments(req.query as any, req.user!.companyId!);
  sendSuccess(res, data);
});

export const getChartInventory = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.getChartInventory(req.query as any, req.user!.companyId!);
  sendSuccess(res, data);
});

export const getChartCustomers = asyncHandler(async (req: AuthRequest, res: Response) => {
  const data = await analyticsService.getChartCustomers(req.query as any, req.user!.companyId!);
  sendSuccess(res, data);
});
